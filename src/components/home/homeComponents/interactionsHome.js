            ...
            <Container className={style.containerButtons}>
                <Card className={style.cardContainerButtons1}>
                    <CardContent className={style.cardContentButtons1}>
                        ...
                        {data.Avatar?<img src={process.env.REACT_APP_API_URL_IMG+`/avatar/${cedula}/${avatar}`} alt={data.Primer_Nombre+''+data.Primer_Apellido} title="" className={style.personButton}/>:<img src={AtenasLogo} alt="Nombre de Usuario" title="" className={style.personButton}/>}
